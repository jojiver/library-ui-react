  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-bold text-gray-900">Borrowings</h2>
        <Select
          className="w-44"
          value={status}
          onChange={(e) => {
          ...
          <TableBody>
            {borrowings.map((borrowing) => (
              <TableRow key={borrowing.id}>
                ...
                <TableCell>{borrowing.borrower_email}</TableCell>
                <TableCell>{borrowing.borrowed_at.slice(0, 10)}</TableCell>
                <TableCell>
